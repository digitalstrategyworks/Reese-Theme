<?php
/* 
 * Theoretically, based on template heirarchy, this page should never be reached
 * I have plugged in the same template as archive.php, in the event that there
 * is some sort of accident. But in no case should the other template files not
 * be navigated to by a user.
 *
*/
...
<div id="content" class="grid_16">
	...
	<div id="categoryContent" class="grid_12">
		...
		<div id="navigation">
			<div id='nav_left'>
				<?php next_posts_link('Ç Older Entries') ?>
			</div>
			
			<div id='nav_right'>
				<?php previous_posts_link('Newer Entries È') ?>
			</div>
		</div>
