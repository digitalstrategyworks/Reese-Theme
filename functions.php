...
if ( !class_exists( 'DifferentType' ) ) {
	...
	class bigstory_widget extends WP_Widget {
		...
		?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('image'); ?>">Image Credit:</label>
				<input type="text" class="heading form-input-tip" id="<?php echo $this->get_field_id('credit'); ?>" name="<?php echo $this->get_field_name('credit'); ?>" value="<?php echo $instance['credit']; ?>" />
			</p>
			<p>
				<label for="<?php echo $this->get_field_id('permalink'); ?>">Permalink: *</label>
				<input type="text" class="heading form-input-tip" id="<?php echo $this->get_field_id('permalink'); ?>" name="<?php echo $this->get_field_name('permalink'); ?>" value="<?php echo $instance['permalink']; ?>" />
		...
		function widget($args, $instance) {
			...
			$permalink = $instance['permalink'];
                        ...
                        echo '<a href="' . $permalink . '"><img height="293" width="940" src="' . $image . '" /></a>';

                        if ($headline) {
                            echo '<span class="orbit-caption"><a href="' . $permalink . '"><p class="head">' . $headline . '</p></a>';
                            if ($subhead) {
                                echo '<a href="' . $permalink . '"><p class="subhead">' . $subhead . '</p></a>';
                            }
                            if ($byline) {
                        ...
                        if ($credit) {
                            echo '<span class="photo-credit">' . $credit . '</span>';
                        }
